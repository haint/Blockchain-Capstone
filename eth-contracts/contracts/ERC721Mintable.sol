...
contract Ownable {
    ...
    event OnwershipTransferred(address _address);
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        _owner = newOwner;
        emit OnwershipTransferred(newOwner);
    }
}
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != tokenOwner, 'the given address to not be the owner of the tokenId');
    ...
    function transferFrom(address from, address to, uint256 tokenId) public {
        require(_isApprovedOrOwner(msg.sender, tokenId), 'Only onwer or approved');
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == tokenOwner, 'from address is the owner of the given token');

        //require token is being transfered to valid address
        require(to != address(0), 'token is being transfered to valid address');
...
contract CapToken is ERC721Metadata("Capstone token", "CS", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
